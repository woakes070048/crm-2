...
<div class="card">
    <div class="card-header">
        ...
        @endif
        <h2 class="h4 card-title pt-5">{{ $place->name }}<span class="float-md-right"><span class="badge badge-pill badge-default">{{ $place->status }}</span><span class="badge badge-pill badge-default ml-1">{{ $place->type }}</span></span></h2>
