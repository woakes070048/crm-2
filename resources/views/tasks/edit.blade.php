		...
		<div class="row">
			...
			<div class="col-md-2">
				<div class="form-group">
					...
					<select class="form-control" name="type" aria-describedby="type" value="{{ $place->type }}">
				...
				<div class="form-group">
					...
					<select id="status" class="form-control" name="status" aria-describedby="company" value="{{ $place->status }}">
