...
<div class="card-open">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <img class="float-left rounded-circle mr-3" width="160" height="160" src="http://placehold.it/160x160&text=No%20Image" alt="" />
            @else
    ...
    <div class="card-footer card-block">
        <div class="row align-items-center">
            <div class="col">
                <p class="float-left mr-3"><i class="fa fa-id-card fa-2x fa-fw text-muted"></i></p>
                <p>ID#: {{$person->id}}</p>
            </div>
            <div class="col">
                <p class="float-left mr-3"><i class="fa fa-plus-square fa-2x fa-fw text-muted"></i></p>
                <p>Created: {{$person->created_at}}</p>
            </div>
            <div class="col">
                <p class="float-left mr-3"><i class="fa fa-pencil-square fa-2x fa-fw text-muted"></i></p>
