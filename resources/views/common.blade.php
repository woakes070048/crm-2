    ...
    <nav id="nav" class="navbar navbar-toggleable-md navbar-inverse sticky-top">
        ...
        <div class="collapse navbar-collapse" id="topnav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-money fa-fw"></i>&nbsp;Money</a></li>
                <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-clock-o fa-fw"></i>&nbsp;Times</a></li>
                <li class="nav-item mr-3"><a class="nav-link" href="#"><i class="fa fa-puzzle-piece fa-fw"></i>&nbsp;Things</a></li>
    ...
    <div id="sub" style="padding-bottom: 50px;">
        <nav class="navbar navbar-inverse py-3 px-3">
            <ul class="nav row align-items-center px-3">
                <li class="nav-item">
                    <a href="javascript:history.go(-1)"><i class="fa fa-arrow-left fa-fw mr-1"></i></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#"><h1 class="hidden-sm-down">@yield('title')</h1></a>
                </li>
                @yield('actions')
            </ul>
        </nav>
    </div>
    <main class="mx-3" style="margin-top: -50px;">
        @yield('content')
    </main>
    @yield('form-close') 
