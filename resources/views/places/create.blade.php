...
@section('form-open')
{!! Form::model($place, array('route' => 'places.store', 'method' => 'POST', 'files' => true)) !!}
@endsection
...
<div class="card">
			...
			<div class="col main">
				...
				<div class="form-group row">
					<div class="col-md-3">
						...
						<input id="division" class="form-control" name="division" type="text" aria-describedby="division">
					</div>
					<div class="col">
						<label class="text-muted" for="parent"><i class="text-muted fa fa-building fa-fw mr-1"></i>Parent</label>
	...
	<div class="card-block">
		<div class="form-group row">
			<div class="col">
				<label class="text-muted" for="phone"><i class="text-muted fa fa-map-signs fa-fw mr-1"></i>Address</label>
				<input id="address" class="form-control" name="address" type="text" aria-describedby="phone">
			</div>
			<div class="col">
				<label class="text-muted" for="email" ><i class="text-muted fa fa-street-view fa-fw mr-1"></i>Address 2</label>
				<input id="address2" class="form-control" name="address2" type="text" aria-describedby="email">
			</div>
		</div>
		<div class="form-group row">
			<div class="col">
				<label class="text-muted" for="phone"><i class="text-muted fa fa-map-marker fa-fw mr-1"></i>City</label>
				<input id="address" class="form-control" name="city" type="text" aria-describedby="phone">
			</div>
			<div class="col">
				<label class="text-muted" for="email" ><i class="text-muted fa fa-map fa-fw mr-1"></i>State/Province</label>
				<input id="address2" class="form-control" name="state" type="text" aria-describedby="email">
			</div>
			<div class="col">
				<label class="text-muted" for="phone"><i class="text-muted fa fa-location-arrow fa-fw mr-1"></i>Zip</label>
				<input id="address" class="form-control" name="zip" type="text" aria-describedby="phone">
			</div>
			<div class="col">
				<label class="text-muted" for="email" ><i class="text-muted fa fa-globe fa-fw mr-1"></i>Country</label>
